...
namespace RayTracer
{
    ...
    public class Image
    {
        ...
        /// <summary>
        /// Write image as PNG to an arbitrary stream (e.g. an HTTP response
        /// body). Shares the encoder with the file-based overload.
        /// </summary>
        ...
        /// <summary>
        /// Encode the image as PNG bytes in memory. Used by the web API to
        /// return a render without touching the filesystem.
        /// </summary>
