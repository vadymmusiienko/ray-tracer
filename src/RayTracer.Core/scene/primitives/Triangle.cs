...
namespace RayTracer
{
    ...
    public class Triangle : SceneEntity
    {
        ...
        public RayHit Intersect(Ray ray)
        {
            ...
            // Return the geometric normal as-is (do NOT pre-flip it to face the
            // ray). Shading orients the normal toward the viewer itself, while
            // refraction relies on the sign of D·N to distinguish a ray
            // entering the surface from one exiting it. Pre-flipping here made
            // every hit look like "entering", which broke refraction through
            // solids (no exit ray, hence no total internal reflection).
