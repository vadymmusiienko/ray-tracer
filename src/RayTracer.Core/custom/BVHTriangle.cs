...
namespace RayTracer
{
    ...
    class BVHTriangle
    {
        ...
        public RayHit Intersect(Ray ray)
        {
            ...
            // Do NOT pre-flip the normal to face the ray. Shading orients it
            // toward the viewer itself; refraction relies on the sign of D·N to
            // tell entering from exiting (pre-flipping broke total internal
            // reflection through meshes).
